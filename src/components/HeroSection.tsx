  ...
  return (
    <section className="relative w-full h-[65vh] md:h-screen overflow-hidden">
      ...
      <div className="relative z-10 flex flex-col items-center justify-center h-full text-center px-4 md:px-8">
        ...
        <h1 className="hero-title mb-4">FATBOY
FRIED<br />FRIED RICE</h1>
        <p className="text-primary-foreground text-base md:text-xl font-bold tracking-[0.25em] uppercase mb-6" style={{ fontFamily: 'var(--font-display)', textShadow: '1px 2px 4px rgba(0,0,0,0.4)' }}>
          FLAVOR, EVERY TIME
        </p>
